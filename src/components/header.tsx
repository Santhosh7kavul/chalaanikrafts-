...
export default function Header() {
  ...
  className={`flex items-center space-x-2 text-xl md:text-2xl font-bold transition-colors ${
    scrolled ? 'text-black' : 'text-white/90 hover:text-white'
  }`}
>
  <img src="logo.png" alt="Logo" className="h-8 w-8 md:h-12 md:w-12" />
  <span>Chalaanikrafts info</span>
</motion.div>
          </Link>
